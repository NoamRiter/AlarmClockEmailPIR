...
webpage += "</div>\n";
  ...
  if (greenLEDStatus)
  {
    webpage += "<button id=\"1\" type=\"button\" class=\"btn btn-success\" onClick=\"sendPWM(1,1)\">PIR on</button>\n";
  }
  else
  {
    webpage += "<button id=\"1\" type=\"button\" class=\"btn btn-danger\" onClick=\"sendPWM(1,1)\">PIR off</button>\n";
  }
  webpage += "</div>\n";
